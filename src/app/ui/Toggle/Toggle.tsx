...
export function Toggle({
  ...
  const [trackBg, setTrackBg] = useState(bgLight);
  ...
  }, [bgDark, bgLight, currentMode, fillDark, fillLight, onCurrentModeChange]);
  return (
    <div
      aria-label="Toggle"
